...
apt-get -qq update
apt-get install -y gawk dialog apt-utils flex bison binutils texinfo gcc g++ libisl-dev packaging-dev build-essential libtool autotools-dev autoconf pkg-config
